...
* [Node.js](https://nodejs.org/en/download/) (>=v22) Installation instructions for [Linux](https://github.com/nodesource/distributions), use installers for macOS and Windows (don't forget to restart your Bash shell)
...
* [Error Handling in Node.js](https://nodejs.org/api/errors.html#errors)
